...
<head>
  ...
  <style>
    ...
    /* ✅ GENEL TAB ANİMASYONU (CONTACT HARİÇ) */
...
<div class="container-fluid">
  <div class="row layout">
    ...
    <div class="col-md-4 col-lg-3 profile text-center">
      <img src="assets/tutiprofil1.jpeg" alt="Profile photo">
      <h4>Tutku Stephan</h4>
      <p class="text-muted">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="photos">
          ...
          <div class="row g-4 mt-3 photo-grid">
            <div class="col-md-4"><img src="assets/ost1.png"></div>
            <div class="col-md-4"><img src="assets/kar1.JPG"></div>
            <div class="col-md-4"><img src="assets/bik1.JPG"></div>
          </div>
        </div>
